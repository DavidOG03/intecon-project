...
const Dropdown = () => {
  ...
  return (
    ...
    >
      <p className="nav-link inline-block mx-4 text-[#f0f0f0] font-jakarta text-[12px] tracking-[0.6px] hover:cursor-pointer">
        Projects
      </p>
      {isDropdownVisible && (
        <ul className="dropdown ">
          <li className="dropdown-item inline-block ml-2 text-left font-jakarta text-[12px] tracking-[0.6px]">
