...
const Quote = () => {
  ...
  return (
    ...
    <motion.h3 
     ...
     whileInView="visible"
     viewport={{ once: true }}
    className="font-jakarta capitalize text-white tracking-tight leading-tight text-[54px] md:text-[90px] text-left mb-12 max-w-[520px]">Let's Work Together</motion.h3>
    <div className="quote-btns flex flex-row gap-6">
        <Link to="/contact" className='quote-btn py-4 px-8 bg-[#fff] border-[2px] text-[18px] tracking-wide font-jakarta rounded-[48px] transition ease-in-out hover:bg-transparent hover:text-[#fff] font-semibold'>Contact Us <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#110F0E" className='inline-block transition-all ml-2'><path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z"/></svg></Link>
