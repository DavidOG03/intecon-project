...
const Quote = () => {
  return (
    ...
    <h3 className="font-jakarta capitalize text-white tracking-tight leading-tight text-[72px] md:text-[90px] text-left font-semibold mb-12 max-w-[520px]">Let's Work Together</h3>
