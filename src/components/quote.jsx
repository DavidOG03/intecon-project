...
const Quote = () => {
  ...
  return (
    <section className="quote py-[80px] flex flex-col justify-center items-start md:flex-row  md:justify-between md:items-center px-6 bg-fixed">
    <motion.h3 
     variants={fadeup}
     initial="hidden"
     whileInView="visible"
     viewport={{ once: true }}
    className="font-jakarta capitalize text-white tracking-tight leading-tight text-[68px] lg:text-[90px] text-left max-w-[320px] lg:max-w-[520px]">Let's Work Together</motion.h3>
