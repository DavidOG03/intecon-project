...
const Quote = () => {
  return (
    <section className="quote py-[120px] flex flex-row justify-between items-center px-6">
    <h3 className="font-jakarta capitalize text-white tracking-tight leading-tight text-[90px] text-left font-semibold mb-12 max-w-[520px] pl-6">Let's Work Together</h3>
