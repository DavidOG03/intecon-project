...
const Quote = () => {
  return (
    ...
    <h3 className="font-jakarta capitalize text-white tracking-tight leading-tight text-[54px] md:text-[90px] text-left mb-12 max-w-[520px]">Let's Work Together</h3>
