...
const Footer = () => {
  return (
      ...
      <footer className='py-2 px-4 md:px-12 bg-black w-full flex flex-wrap gap-4 justify-between items-center border-t border-t-[#292828] relative z-50 '>
        <Link to="/"><img src="/images/intecon-logo-too.png" alt="intecon logo too" className='h-[34px] md:h-[54px]'/></Link>
        <span className="certification px-1 md:px-4 py-2 bg-[#f0f0f0] border border-[#837f7f] inline-block text-[11px] md:text-[12px] font-jakarta">
