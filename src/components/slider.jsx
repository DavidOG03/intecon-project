    ...
    <>
      <Slider {...settings}>
        <div className="hero-image first-image bg-gradient-to-br from-[#5161bb] to-[#7683ca] bg-cover bg-no-repeat bg-center w-full h-auto flex justify-start items-center flex-grow">
          <h3 className="font-bold text-[#fff] text-[90px] ml-8 absolute top-[40%] left-[0%] -translate-y-[60%] font-jakarta tracking-tight leading-tight text-left w-full ">
        ...
        <div className="hero-image fourth-image bg-heroImageFour w-full h-auto flex-grow">
          ...
          <h3 className="font-bold text-[#fff] text-[90px] ml-8 absolute top-[40%] left-[0%]  -translate-y-[60%] font-jakarta tracking-tight leading-tight text-left max-w-[75%] w-full ">
            <span className="block text-[#fff]">Intecon Patnership Ltd</span>
