          ...
          <table className="max-w-[750px] mx-auto bg-white border border-gray-300 basis-[80%]">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  Consultancy Services for the Supervision of the Rehabilitation
                  of Kunya- Kanya – Babura - Bababmutum Road
                </td>
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  2013
                </td>
              ...
              <tr>
                ...
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  Emergency Reconstruction of Flooded Sections of Abuja – Lokoja
                  Road, CH 23 + 400 to CH 26 + 395 (Kotonkarfe – Lokoja) in Kogi
                  State.
                </td>
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  2013
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  ...
                  Rehabilitation of Mokwa – New Bussa –Kaima to Oyo State Border
                  in Niger/Kwara States.
                </td>
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  2010
                </td>
          ...
          <table className="max-w-[750px] mx-auto bg-white border border-gray-300 basis-[80%] hidden">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  Structural Engineering Design and Construction Supervision of
                  Ilorin Cargo Terminal.
                </td>
                <td className="px-2 md:px-4 py-2 border border-gray-300 text-left text-[14px] md:text-base font-inter">
                  2018 - 2010
                </td>
